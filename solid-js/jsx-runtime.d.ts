...
*/ 
      ...
      export interface HTMLWebViewElementAttributes<T extends HTMLWebViewElement = HTMLWebViewElement> extends HTMLViewElementAttributes<T> {
  
        
           
          "on:loadStarted": (payload: NativeDOMEventWithData<HTMLWebViewElement, LoadEventData>) => void;

          

           
          "on:loadFinished": (payload: NativeDOMEventWithData<HTMLWebViewElement, LoadEventData>) => void;
...
*/ 
      ...
      export interface HTMLTimePickerElementAttributes<T extends HTMLTimePickerElement = HTMLTimePickerElement> extends HTMLViewElementAttributes<T> {
  
        
           
          "on:timeChange": (payload: NativeDOMPropertyChangeEvent<HTMLTimePickerElement> | undefined) => void;
...
*/ 
      ...
      export interface HTMLTextViewElementAttributes<T extends HTMLTextViewElement = HTMLTextViewElement> extends HTMLViewElementAttributes<T> {
  
        
           
          "on:focus": (payload: NativeDOMPropertyChangeEvent<HTMLTextViewElement>) => void;

          

           
          "on:returnPress": (payload: NativeDOMPropertyChangeEvent<HTMLTextViewElement>) => void;

          

           
          "on:blur": (payload: NativeDOMPropertyChangeEvent<HTMLTextViewElement>) => void;

          

           
          "on:textChange": (payload: NativeDOMPropertyChangeEvent<HTMLTextViewElement>) => void;
...
*/ 
      ...
      export interface HTMLTextFieldElementAttributes<T extends HTMLTextFieldElement = HTMLTextFieldElement> extends HTMLViewElementAttributes<T> {
  
        
           
          "on:focus": (payload: NativeDOMPropertyChangeEvent<HTMLTextFieldElement>) => void;

          

           
          "on:returnPress": (payload: NativeDOMPropertyChangeEvent<HTMLTextFieldElement>) => void;

          

           
          "on:blur": (payload: NativeDOMPropertyChangeEvent<HTMLTextFieldElement>) => void;

          

           
          "on:textChange": (payload: NativeDOMPropertyChangeEvent<HTMLTextFieldElement>) => void;
...
*/ 
      ...
      export interface HTMLTabViewItemElementAttributes<T extends HTMLTabViewItemElement = HTMLTabViewItemElement> extends HTMLViewElementAttributes<T> {
...
*/ 
      ...
      export interface HTMLTabViewElementAttributes<T extends HTMLTabViewElement = HTMLTabViewElement> extends HTMLViewElementAttributes<T> {
  
        
           
          "on:selectedIndexChanged": (payload: NativeDOMEventWithData<HTMLTabViewElement, SelectedIndexChangedEventData>) => void;
...
*/ 
      ...
      export interface HTMLSwitchElementAttributes<T extends HTMLSwitchElement = HTMLSwitchElement> extends HTMLViewElementAttributes<T> {
  
        
           
          "on:checkedChange": (payload: NativeDOMPropertyChangeEvent<HTMLSwitchElement>) => void;
...
*/ 
      ...
      export interface HTMLSpanElementAttributes<T extends HTMLSpanElement = HTMLSpanElement> extends HTMLViewElementAttributes<T> {
...
*/ 
      ...
      export interface HTMLFormattedStringElementAttributes<T extends HTMLFormattedStringElement = HTMLFormattedStringElement> extends HTMLViewElementAttributes<T> {
...
*/ 
      ...
      export interface HTMLSegmentedBarItemElementAttributes<T extends HTMLSegmentedBarItemElement = HTMLSegmentedBarItemElement> extends HTMLViewElementAttributes<T> {
...
*/ 
      ...
      export interface HTMLSegmentedBarElementAttributes<T extends HTMLSegmentedBarElement = HTMLSegmentedBarElement> extends HTMLViewElementAttributes<T> {
  
        
           
          "on:selectedIndexChanged": (payload: NativeDOMEventWithData<HTMLSegmentedBarElement, SelectedIndexChangedEventData>) => void;
...
*/ 
      ...
      export interface HTMLSliderElementAttributes<T extends HTMLSliderElement = HTMLSliderElement> extends HTMLViewElementAttributes<T> {
  
        
           
          "on:accessibilityDecrement": (payload: NativeDOMEventWithData<HTMLSliderElement, AccessibilityIncrementEventData>) => void;

          

           
          "on:accessibilityIncrement": (payload: NativeDOMEventWithData<HTMLSliderElement, AccessibilityDecrementEventData>) => void;
...
*/ 
      ...
      export interface HTMLSearchBarElementAttributes<T extends HTMLSearchBarElement = HTMLSearchBarElement> extends HTMLViewElementAttributes<T> {
...
*/ 
      ...
      export interface HTMLScrollViewElementAttributes<T extends HTMLScrollViewElement = HTMLScrollViewElement> extends HTMLViewElementAttributes<T> {
...
*/ 
      ...
      export interface HTMLRepeaterElementAttributes<T extends HTMLRepeaterElement = HTMLRepeaterElement> extends HTMLViewElementAttributes<T> {
      ...
      export interface HTMLPlaceholderElementAttributes<T extends HTMLPlaceholderElement = HTMLPlaceholderElement> extends HTMLViewElementAttributes<T> {
  
        
           
          "on:creatingView": (payload: NativeDOMEventWithData<HTMLPlaceholderElement, CreateViewEventData>) => void;
      ...
      export interface HTMLProxyViewContainerElementAttributes<T extends HTMLProxyViewContainerElement = HTMLProxyViewContainerElement> extends HTMLViewElementAttributes<T> {
...
*/ 
      ...
      export interface HTMLPageElementAttributes<T extends HTMLPageElement = HTMLPageElement> extends HTMLViewElementAttributes<T> {
          ...
          "on:navigatingFrom": (payload: NativeNavigationEvent<HTMLPageElement>) => void;
...
*/ 
      ...
      export interface HTMLProgressElementAttributes<T extends HTMLProgressElement = HTMLProgressElement> extends HTMLViewElementAttributes<T> {
  
        
           
          "on:valueChange": (payload: NativeDOMPropertyChangeEvent<HTMLProgressElement>) => void;
...
*/ 
      ...
      export interface HTMLListViewElementAttributes<T extends HTMLListViewElement = HTMLListViewElement> extends HTMLViewElementAttributes<T> {
  
        
           
          "on:itemLoading": (payload: NativeDOMEventWithData<HTMLListViewElement, ItemEventData>) => void;

          

           
          "on:itemTap": (payload: NativeDOMEventWithData<HTMLListViewElement, ItemEventData>) => void;
...
*/ 
      ...
      export interface HTMLListPickerElementAttributes<T extends HTMLListPickerElement = HTMLListPickerElement> extends HTMLViewElementAttributes<T> {
  
        
           
          "on:selectedIndexChange": (payload: NativeDOMPropertyChangeEvent<HTMLListPickerElement> | undefined) => void;

          

           
          "on:selectedValueChange": (payload: NativeDOMPropertyChangeEvent<HTMLListPickerElement> | undefined) => void;
...
*/ 
      ...
      export interface HTMLLabelElementAttributes<T extends HTMLLabelElement = HTMLLabelElement> extends HTMLViewElementAttributes<T> {
...
*/ 
      ...
      export interface HTMLHtmlViewElementAttributes<T extends HTMLHtmlViewElement = HTMLHtmlViewElement> extends HTMLViewElementAttributes<T> {
...
*/ 
      ...
      export interface HTMLImageElementAttributes<T extends HTMLImageElement = HTMLImageElement> extends HTMLViewElementAttributes<T> {
...
*/ 
      ...
      export interface HTMLFrameElementAttributes<T extends HTMLFrameElement = HTMLFrameElement> extends HTMLViewElementAttributes<T> {
...
*/ 
      ...
      export interface HTMLDatePickerElementAttributes<T extends HTMLDatePickerElement = HTMLDatePickerElement> extends HTMLViewElementAttributes<T> {
  
        
           
          "on:dateChange": (payload: NativeDOMPropertyChangeEvent<HTMLDatePickerElement>) => void;
...
*/ 
      ...
      export interface HTMLContentViewElementAttributes<T extends HTMLContentViewElement = HTMLContentViewElement> extends HTMLViewElementAttributes<T> {
...
*/ 
      ...
      export interface HTMLButtonElementAttributes<T extends HTMLButtonElement = HTMLButtonElement> extends HTMLViewElementAttributes<T> {
...
*/ 
      ...
      export interface HTMLActionBarElementAttributes<T extends HTMLActionBarElement = HTMLActionBarElement> extends HTMLViewElementAttributes<T> {
...
*/ 
      ...
      export interface HTMLActionItemElementAttributes<T extends HTMLActionItemElement = HTMLActionItemElement> extends HTMLViewElementAttributes<T> {
...
*/ 
      ...
      export interface HTMLNavigationButtonElementAttributes<T extends HTMLNavigationButtonElement = HTMLNavigationButtonElement> extends HTMLViewElementAttributes<T> {
...
*/ 
      ...
      export interface HTMLActivityIndicatorElementAttributes<T extends HTMLActivityIndicatorElement = HTMLActivityIndicatorElement> extends HTMLViewElementAttributes<T> {
...
*/ 
      ...
      export interface HTMLStackLayoutElementAttributes<T extends HTMLStackLayoutElement = HTMLStackLayoutElement> extends HTMLViewElementAttributes<T> {
...
*/ 
      ...
      export interface HTMLRootLayoutElementAttributes<T extends HTMLRootLayoutElement = HTMLRootLayoutElement> extends HTMLViewElementAttributes<T> {
...
*/ 
      ...
      export interface HTMLDockLayoutElementAttributes<T extends HTMLDockLayoutElement = HTMLDockLayoutElement> extends HTMLViewElementAttributes<T> {
...
*/ 
      ...
      export interface HTMLFlexboxLayoutElementAttributes<T extends HTMLFlexboxLayoutElement = HTMLFlexboxLayoutElement> extends HTMLViewElementAttributes<T> {
...
*/ 
      ...
      export interface HTMLWrapLayoutElementAttributes<T extends HTMLWrapLayoutElement = HTMLWrapLayoutElement> extends HTMLViewElementAttributes<T> {
...
*/ 
      ...
      export interface HTMLGridLayoutElementAttributes<T extends HTMLGridLayoutElement = HTMLGridLayoutElement> extends HTMLViewElementAttributes<T> {
...
*/ 
      ...
      export interface HTMLAbsoluteLayoutElementAttributes<T extends HTMLAbsoluteLayoutElement = HTMLAbsoluteLayoutElement> extends HTMLViewElementAttributes<T> {
...
*/ 
      ...
      export interface HTMLContainerViewElementAttributes<T extends HTMLContainerViewElement = HTMLContainerViewElement> extends HTMLViewElementAttributes<T> {
      ...
      export interface HTMLCustomLayoutViewElementAttributes<T extends HTMLCustomLayoutViewElement = HTMLCustomLayoutViewElement> extends HTMLViewElementAttributes<T> {
