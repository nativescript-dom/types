...
declare module "ns-solid/jsx-runtime" {
  export interface NSDOMAttributes<T>
    extends SolidJSX.CustomAttributes<T>,
      SolidJSX.DirectiveAttributes,
      SolidJSX.DirectiveFunctionAttributes<T> {}
...
*/
    ...
    export interface ActionItemAttributes
      extends Omit<ViewBaseAttributes<ActionItem>, "on:tap"> {
      /**
       ...
       * String value used when hooking to layoutChanged event.
       */
      "on:tap"?: (event: NSDOMEvent<EventData>) => void;
    }
    ...
    export interface ButtonAttributes extends ViewAttributes<Button> {
       ...
       */
      "on:string;"?: (event: NSDOMEvent<EventData>) => void;
    }
...
*/
       ...
       */
      "on:dateChange"?: (event: NSDOMEvent<PropertyChangeData>) => void;
    }
...
*/
    ...
    export interface EditableTextBaseAttributes
       ...
       */
      "on:blurEvent"?: (event: NSDOMEvent<EventData>) => void;

      /**
       * String value used when hooking to the focus event.
       */
      "on:focusEvent"?: (event: NSDOMEvent<EventData>) => void;

      /**
       * String value used when hooking to the textChange event.
       */
      "on:textChangeEvent"?: (event: NSDOMEvent<PropertyChangeData>) => void;
    }

    export interface FlexboxLayoutAttributes
      extends ViewAttributes<FlexboxLayout> {
      /**
...
*/
    ...
    export interface FrameAttributes extends ViewAttributes<Frame> {
       ...
       */
      "on:optionSelected"?: (event: NSDOMEvent<EventData>) => void;

      /**
       * String value used when hooking to navigatingTo event.
       */
      "on:navigatingTo"?: (event: NSDOMEvent<NavigationData>) => void;

      /**
       * String value used when hooking to navigatedTo event.
       */
      "on:navigatedTo"?: (event: NSDOMEvent<NavigationData>) => void;
    }
...
*/
       ...
       */
      "on:isLoading"?: (event: NSDOMEvent<PropertyChangeData>) => void;
    }
...
*/
      ...
      "on:selectedIndexChange"?: (
        event: NSDOMEvent<PropertyChangeData>,
      ) => void;
    }
...
*/
       ...
       */
      "on:itemLoading"?: (event: NSDOMEvent<ItemEventData>) => void;

      /**
       * String value used when hooking to itemTap event.
       */
      "on:itemTap"?: (event: NSDOMEvent<ItemEventData>) => void;
    }
...
*/
       ...
       * String value used when hooking to navigatingTo event.
       */
      "on:navigatingTo"?: (event: NSDOMEvent<NavigatedData>) => void;

      /**
       * String value used when hooking to navigatedTo event.
       */
      "on:navigatedTo"?: (event: NSDOMEvent<NavigatedData>) => void;

      /**
       * String value used when hooking to navigatingFrom event.
       */
      "on:navigatingFrom"?: (event: NSDOMEvent<NavigatedData>) => void;

      /**
       * String value used when hooking to navigatedFrom event.
       */
      "on:navigatedFrom"?: (event: NSDOMEvent<NavigatedData>) => void;
    }
    ...
    export interface PlaceholderAttributes extends ViewAttributes<Placeholder> {
       ...
       */
      "on:creatingView"?: (event: NSDOMEvent<CreateViewEventData>) => void;
    }
    ...
    export interface ProgressAttributes extends ViewAttributes<Progress> {
       ...
       */
      "on:valueChange"?: (event: NSDOMEvent<PropertyChangeData>) => void;
    }
...
*/
    ...
    export interface SearchBarAttributes extends ViewAttributes<SearchBar> {
       ...
       */
      "on:submit"?: (event: NSDOMEvent<EventData>) => void;
    }

    export interface SegmentedBarAttributes
      extends ViewAttributes<SegmentedBar> {
      /**
    ...
    export interface SpanAttributes extends ViewBaseAttributes<Span> {
       ...
       */
      "on:linkTap"?: (event: NSDOMEvent<EventData>) => void;
    }
...
*/
    ...
    export interface SwitchAttributes extends ViewAttributes<Switch> {
       ...
       */
      "on:checkedChange"?: (event: NSDOMEvent<PropertyChangeData>) => void;
    }
...
*/
    ...
    export interface TabViewItemAttributes
      extends ViewBaseAttributes<TabViewItem> {
      /**
    ...
    export interface TextFieldAttributes extends ViewAttributes<TextField> {
       ...
       */
      "on:returnPress"?: (event: NSDOMEvent<EventData>) => void;
...
*/
       ...
       */
      "on:timeChange"?: (event: NSDOMEvent<EventData>) => void;
    }
...
*/
       ...
       */
      "on:loadStarted"?: (event: NSDOMEvent<LoadEventData>) => void;

      /**
       * String value used when hooking to loadFinished event.
       */
      "on:loadFinished"?: (event: NSDOMEvent<LoadEventData>) => void;
    }
...
*/
    ...
    export interface IntrinsicElements {
      ...
      editabletextbase: EditableTextBaseAttributes;
