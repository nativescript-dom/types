...
*/
  ...
  /**
     * undefined
@type CollectionViewItemEventData
*/
  "on:itemLoading"?: (event: NSDOMEvent<CollectionViewItemEventData>) => void;
...
*/
  ...
  /**
     * Gesture Event
@type RotationGestureEventData
*/
  "on:rotation"?: (event: RotationGestureEventData) => void;

  /**
     * Gesture Event
@type GestureEventDataWithState
*/
